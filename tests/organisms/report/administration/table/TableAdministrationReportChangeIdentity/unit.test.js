...
describe("unit.TableAdministrationReportChangeIdentity.vue", () => {
  let mocksFn = {}
  ...
  describe("test mounted lifecycle", () => {
    it.each([
      ...
      wrapper = shallowMount(TableAdministrationReportChangeIdentity, { localVue, mocks, propsData: { is_searching } })
  ...
  describe("test methods", () => {
    beforeEach(() => {
      const propsData = { is_searching: false, month: "2023-01", administration: {text: "Ganti Profil", value: "IDENTITY_CHANGE"} }
    ...
    it("once setMemberType called, should set membership_type with value from $utility.getSpotMembershipType", async () => {
      ...
      wrapper.vm.setMemberType = TableAdministrationReportChangeIdentity.methods.setMemberType
    ...
    it("once processGetData called, should call setPayloadGet, getAdministrationReport, passFormatDownloadReport", async () => {
      ...
      wrapper.vm.processGetData = TableAdministrationReportChangeIdentity.methods.processGetData
